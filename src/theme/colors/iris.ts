...
export const iris = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.iris.9}", _dark: "{colors.iris.9}" },
      },
      hover: {
        value: { _light: "{colors.iris.10}", _dark: "{colors.iris.10}" },
      },
    },
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.iris.a3}", _dark: "{colors.iris.a3}" },
      },
      hover: {
        value: { _light: "{colors.iris.a4}", _dark: "{colors.iris.a4}" },
      },
      active: {
        value: { _light: "{colors.iris.a5}", _dark: "{colors.iris.a5}" },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: "{colors.iris.a11}", _dark: "{colors.iris.a11}" },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.iris.a2}", _dark: "{colors.iris.a2}" },
      },
      active: {
        value: { _light: "{colors.iris.a3}", _dark: "{colors.iris.a3}" },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: "{colors.iris.a6}", _dark: "{colors.iris.a6}" },
      },
      hover: {
        value: { _light: "{colors.iris.a7}", _dark: "{colors.iris.a7}" },
      },
    },
    fg: {
      DEFAULT: {
