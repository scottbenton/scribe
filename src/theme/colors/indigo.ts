...
export const indigo = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.indigo.9}", _dark: "{colors.indigo.9}" },
      },
      hover: {
        value: { _light: "{colors.indigo.10}", _dark: "{colors.indigo.10}" },
      },
    },
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.indigo.a3}", _dark: "{colors.indigo.a3}" },
      },
      hover: {
        value: { _light: "{colors.indigo.a4}", _dark: "{colors.indigo.a4}" },
      },
      active: {
        value: { _light: "{colors.indigo.a5}", _dark: "{colors.indigo.a5}" },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: "{colors.indigo.a11}", _dark: "{colors.indigo.a11}" },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.indigo.a2}", _dark: "{colors.indigo.a2}" },
      },
      active: {
        value: { _light: "{colors.indigo.a3}", _dark: "{colors.indigo.a3}" },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: "{colors.indigo.a6}", _dark: "{colors.indigo.a6}" },
      },
      hover: {
        value: { _light: "{colors.indigo.a7}", _dark: "{colors.indigo.a7}" },
      },
    },
    fg: {
      DEFAULT: {
