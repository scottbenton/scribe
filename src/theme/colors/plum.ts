...
export const plum = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.plum.9}", _dark: "{colors.plum.9}" },
      },
      hover: {
        value: { _light: "{colors.plum.10}", _dark: "{colors.plum.10}" },
      },
    },
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.plum.a3}", _dark: "{colors.plum.a3}" },
      },
      hover: {
        value: { _light: "{colors.plum.a4}", _dark: "{colors.plum.a4}" },
      },
      active: {
        value: { _light: "{colors.plum.a5}", _dark: "{colors.plum.a5}" },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: "{colors.plum.a11}", _dark: "{colors.plum.a11}" },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.plum.a2}", _dark: "{colors.plum.a2}" },
      },
      active: {
        value: { _light: "{colors.plum.a3}", _dark: "{colors.plum.a3}" },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: "{colors.plum.a6}", _dark: "{colors.plum.a6}" },
      },
      hover: {
        value: { _light: "{colors.plum.a7}", _dark: "{colors.plum.a7}" },
      },
    },
    fg: {
      DEFAULT: {
