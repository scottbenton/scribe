...
export const tomato = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.tomato.9}", _dark: "{colors.tomato.9}" },
      },
      hover: {
        value: { _light: "{colors.tomato.10}", _dark: "{colors.tomato.10}" },
      },
    },
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.tomato.a3}", _dark: "{colors.tomato.a3}" },
      },
      hover: {
        value: { _light: "{colors.tomato.a4}", _dark: "{colors.tomato.a4}" },
      },
      active: {
        value: { _light: "{colors.tomato.a5}", _dark: "{colors.tomato.a5}" },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: "{colors.tomato.a11}", _dark: "{colors.tomato.a11}" },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.tomato.a2}", _dark: "{colors.tomato.a2}" },
      },
      active: {
        value: { _light: "{colors.tomato.a3}", _dark: "{colors.tomato.a3}" },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: "{colors.tomato.a6}", _dark: "{colors.tomato.a6}" },
      },
      hover: {
        value: { _light: "{colors.tomato.a7}", _dark: "{colors.tomato.a7}" },
      },
    },
    fg: {
      DEFAULT: {
